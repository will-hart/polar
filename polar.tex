...
\usepackage[separate-uncertainty=true, mode=text, bracket-numbers=false, multi-part-units=single]{siunitx}				% units

\DeclareSIUnit\myMol{\textsc{m}}
\DeclareSIUnit\osmol{osmol}
\DeclareSIUnit\myOhm{\ensuremath{\Omega}}
